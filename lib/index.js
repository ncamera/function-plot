...
module.exports = function (options) {
  ...
  Chart.prototype.buildContent = function () {
    ...
    graphs
      .each(function (d, index) {
        ...
        if (d.graphType == "polyline" &&
            d.polylineType &&
            d.polylineType == 'polygon' &&
            (!self.meta.polygon ||
            !self.meta.polygon.close)
          ) {
          d.points[d.points.length] = d.points[0];
          self.meta.polygon = {}
          self.meta.polygon.close = true;
        }
    ...
    if (this.options.conj) {
      ...
      if (this.options.conj.dom == 'Numer'){
        ...
        if(this.options.conj.baseDom == 'Z'){
          ...
          .scale(xScale)
          .tickSize(options.grid ? -height : 0)
          .tickFormat(function(d) {if (d == Math.round(d) && fun(d)){ return d }})
          .orient('bottom')
        }else{
          this.meta.xAxis = d3.svg.axis()
          .scale(xScale)
          .tickSize(options.grid ? -height : 0)
          .tickFormat(function(d) {if (fun(d)){ return d }})
          .orient('bottom')
        }
      ...
      if (this.options.conj.cod == 'Numer'){
        ...
        var fun = this.options.conj.sets.fcod;
  ...
  Chart.prototype.setUpEventListeners = function () {
    ...
    var events = {
      ...
      if (this.options.conj && this.options.conj.dom =='Func') {
        var fun = this.options.conj.sets.fdom;
      ...
      } else if (this.options.conj && this.options.conj.dom =='Numer' || this.options.conj.dom =='Z' || this.options.conj.dom =='N'){  //Cambio 1 de agosto
          var xRound = Math.round(coordinates.x)
