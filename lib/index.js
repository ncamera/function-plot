...
module.exports = function (options) {
  ...
  Chart.prototype.cleanAxisLabel = function() {
    var instance = this

    instance.canvas.select('.x.axis').remove()
    instance.canvas.select('.y.axis').remove()
    instance.canvas.selectAll('text.x.axis-label').remove()
    instance.canvas.selectAll('text.y.axis-label').remove()
  }
