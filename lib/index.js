...
module.exports = function (options) {
  ...
  Chart.prototype.drawGraphWrapper = function () {
    ...
    // conditions to show the axis
    if (!this.options.hasOwnProperty('axis') || this.options.axis !== false) {
      this.buildAxis()
      this.buildAxisLabel()
    }
  ...
  Chart.prototype.cleanAxis = function() {
    var instance = this
  ...
  Chart.prototype.toggleAxis = function() {
     var instance = this
     var axis = !instance.options.hasOwnProperty('axis') || instance.options.axis !== false
     instance.options.axis = !axis
     if (instance.options.axis) {
        instance.buildAxis()
        instance.buildAxisLabel()
     } else {
        instance.cleanAxis()
     }
     instance.draw()
