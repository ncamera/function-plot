    ...
    selection.each(function (d) {
      ...
      if (innerSelection.node() != null) {
        ...
        if (typeof d.rotation !== "undefined") {
          el.style("-moz-transform-origin", function (d) { return centerBB.cxBB+'px ' + centerBB.cyBB+'px' })
          el.style("-ms-transform-origin", function (d) { return centerBB.cxBB+'px ' + centerBB.cyBB+'px' })
          el.style("-o-transform-origin", function (d) { return centerBB.cxBB+'px ' + centerBB.cyBB+'px' })
          el.style("-webkit-transform-origin", function (d) { return centerBB.cxBB+'px ' + centerBB.cyBB+'px' })
          el.style("transform-origin", function (d) { return centerBB.cxBB+'px ' + centerBB.cyBB+'px' })
