...
module.exports = function (chart) {
    ...
    function drawRectangule (el, shape) {
        ...
        innerSelection
            ...
            // .attr('height', function (d) { var h = yScale(d.y + d.h) - yScale(d.y);  return -h })
            // .attr("transform-origin", function (d) { return origin(d) })
            // .attr("transform", "rotate("+utils.toDegree(shape.rotation)+")")
            ...
            .attr("transform-origin", function (d) { return xScale(d.x)+'px ' + yScale(d.y)+'px' })
            .attr("transform", "rotate("+utils.toDegree(-shape.rotation)+")")
